...
class EpicAuthenticatorFunctionalSpec extends Specification {
    ...
    def setup() {
        ...
        Credentials fhirServiceCredentials = Mock()
        1 * fhirServiceCredentials.getUsername() >> 'user'
        1 * fhirServiceCredentials.getPassword() >> 'pass'
        epicService.fhirServiceCredentials = fhirServiceCredentials
        epicService.init()
